//
//  ChatCollectioViewLayout.swift
//  Dalagram
//
//  Created by Toremurat on 03.07.18.
...
protocol ChatLayoutDelegate: class {
    func collectionView(_ collectionView:UICollectionView, heightForBubleAtIndexPath indexPath:IndexPath) -> CGFloat
}
