...
class MessageInputBarView: UIView {
    ...
    var chatDetailVC: UIViewController?  {
        didSet {
//            sendButton.addTarget(chatDetailVC, action: #selector(UIViewController.sendButtonPressed), for: .touchUpInside)
//            attachButton.addTarget(chatDetailVC, action: #selector(UIViewController.attachButtonPressed), for: .touchUpInside)
        }
    }
