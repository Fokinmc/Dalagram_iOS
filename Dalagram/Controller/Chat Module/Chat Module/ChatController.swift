...
//        viewModel.getDialogMessages(requestSuccess: { [weak self] in
...
//        var nodeData = ASNodeCellData(text: "", date: "Сейчас", name: "Tore", kind: "message", image: "url")
//        let node = ChatBubleNodeCell(message: nodeData, isOutgoing: true, bubbleImage: bubleImageOut)
////        node.delegate = self

//        collectionView?.insertSubnode(node, at: 0)
...
extension ChatController {
    ...
    private func configureUI() {
        ...
        self.collectionView?.view.alwaysBounceVertical = true
