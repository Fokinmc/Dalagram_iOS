...
class Message: NSObject {
    ...
    init(image : String , caption : String){
        ...
        self.imageUrl = image
        self.text = NSAttributedString(string : caption ,attributes : ChatCellNodeContentTextAttributes)
    ...
    init(msg : String){
        ...
        self.text = NSAttributedString(string : msg , attributes : ChatCellNodeContentTextAttributes)
